...
hero:
  ...
  actions:
    - theme: brand
      text: Demo live
      link: https://palestra.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-palestra
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Palestra.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Palestra** in Italia.
...
Il mercato italiano delle PMI per **Palestra** ha caratteristiche specifiche:
...
```bash
git clone https://github.com/fedcal/federico-demo-palestra.git
cd federico-demo-palestra
npm install
npm start
# → http://localhost:4200
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-palestra)
